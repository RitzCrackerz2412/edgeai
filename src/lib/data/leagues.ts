...
const eplStandings: LeagueStanding[] = [
  ...
  st(12,'epl-crystalpalace', 'Crystal Palace',      'CRY','#1B458F',  38,14, 8,16, 50,44, 4,['L','L','W','W','D'],'D1'),
  st(13,'epl-brentford',     'Brentford',           'BRE','#E30613',  38,14, 6,18, 48,48, 0,['W','D','L','W','L'],'L1'),
  st(14,'epl-nottmforest',   "Nottingham Forest",   'NFO','#DD0000',  38,13, 8,17, 47,42,10,['D','L','W','D','W'],'W1'),
  st(15,'epl-everton',       'Everton',             'EVE','#003399',  38,11,10,17, 43,40,-4,['D','L','W','D','D'],'D1'),
  st(16,'epl-wolves',        'Wolverhampton',       'WOL','#FDB913',  38,11, 9,18, 42,38,-8,['L','W','D','L','W'],'W1'),
  st(17,'epl-bournemouth',   'AFC Bournemouth',     'BOU','#DA291C',  38,11, 8,19, 41,41,-8,['W','L','D','L','L'],'L2'),
