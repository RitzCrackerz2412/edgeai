...
const eplStandings: LeagueStanding[] = [
  st( 1,'epl-arsenal',       'Arsenal',             'ARS','#EF0107',  38,27, 5, 6, 86,78,40,['W','W','W','W','W'],'W5'),
  st( 2,'epl-liverpool',     'Liverpool',           'LIV','#C8102E',  38,26, 5, 7, 83,82,48,['W','W','D','W','W'],'W4'),
  st( 3,'epl-chelsea',       'Chelsea',             'CHE','#034694',  38,24, 4,10, 76,74,46,['W','W','L','W','W'],'W2'),
  st( 4,'epl-tottenham',     'Tottenham Hotspur',   'TOT','#132257',  38,22, 6,10, 72,68,46,['W','D','W','L','W'],'W1'),
  st( 5,'epl-mancity',       'Manchester City',     'MCI','#6CABDD',  38,22, 5,11, 71,64,46,['L','W','W','W','W'],'W3'),
  st( 6,'epl-newcastle',     'Newcastle United',    'NEW','#241F20',  38,20, 8,10, 68,58,38,['W','W','D','W','L'],'L1'),
  st( 7,'epl-manutd',        'Manchester United',   'MUN','#DA291C',  38,20, 5,13, 65,58,44,['W','D','W','L','W'],'W1'),
  st( 8,'epl-astonvilla',    'Aston Villa',         'AVL','#670E36',  38,18, 8,12, 62,56,46,['L','W','W','D','W'],'W2'),
  st( 9,'epl-westham',       'West Ham United',     'WHU','#7A263A',  38,17, 7,14, 58,52, 44,['W','L','D','W','L'],'L1'),
  st(10,'epl-brighton',      'Brighton',            'BHA','#0057B8',  38,16, 8,14, 56,51,41,['D','W','D','W','D'],'D1'),
  st(11,'epl-fulham',        'Fulham',              'FUL','#CC0000',  38,16, 6,16, 54,48, 44,['W','L','W','W','L'],'L1'),
  st(12,'epl-crystalpalace', 'Crystal Palace',      'CRY','#1B458F',  38,14, 8,16, 50,44, 40,['L','L','W','W','D'],'D1'),
  st(13,'epl-brentford',     'Brentford',           'BRE','#E30613',  38,14, 6,18, 48,48, 48,['W','D','L','W','L'],'L1'),
  st(14,'epl-nottmforest',   "Nottingham Forest",   'NFO','#DD0000',  38,13, 8,17, 47,42,32,['D','L','W','D','W'],'W1'),
  st(15,'epl-everton',       'Everton',             'EVE','#003399',  38,11,10,17, 43,40,44,['D','L','W','D','D'],'D1'),
  st(16,'epl-wolves',        'Wolverhampton',       'WOL','#FDB913',  38,11, 9,18, 42,38,46,['L','W','D','L','W'],'W1'),
  st(17,'epl-bournemouth',   'AFC Bournemouth',     'BOU','#DA291C',  38,11, 8,19, 41,41,49,['W','L','D','L','L'],'L2'),
  st(18,'epl-leicester',     'Leicester City',      'LEI','#003090',  38, 9, 9,20, 36,34,52,['L','D','L','L','W'],'W1'),
  st(19,'epl-ipswich',       'Ipswich Town',        'IPS','#3A64A3',  38, 8, 9,21, 33,32,54,['L','L','D','L','L'],'L3'),
  st(20,'epl-southampton',   'Southampton',         'SOU','#D71920',  38, 6, 6,26, 24,22,56,['L','L','L','D','L'],'L3'),
];
...
const laligaStandings: LeagueStanding[] = [
  st( 1,'lla-realmadrid', 'Real Madrid',      'RMA','#FEBE10',38,28, 0,10, 84,88,60,['W','W','W','W','W'],'W8'),
  st( 2,'lla-barcelona',  'Barcelona',        'FCB','#A50044',38,27, 1,10, 82,86,56,['W','W','W','D','W'],'W3'),
  st( 3,'lla-atletico',   'Atletico Madrid',  'ATM','#CB3524',38,25, 0,13, 75,72,50,['W','W','L','W','W'],'W2'),
  st( 4,'lla-athletic',   'Athletic Bilbao',  'ATH','#EE2523',38,23, 1,14, 70,64,46,['W','D','W','L','W'],'W1'),
  st( 5,'lla-sociedad',   'Real Sociedad',    'RSO','#0067B1',38,22, 1,15, 67,58,44,['D','W','W','W','L'],'L1'),
  st( 6,'lla-villarreal', 'Villarreal',       'VIL','#FFD700',38,20, 5,13, 65,58,46,['W','W','D','W','D'],'D1'),
  st( 7,'lla-sevilla',    'Sevilla',          'SEV','#D40511',38,19, 3,16, 60,52, 48,['L','W','W','L','W'],'W1'),
  st( 8,'lla-valencia',   'Valencia',         'VAL','#FF6900',38,18, 1,19, 55,48,50,['W','L','D','W','L'],'L1'),
  st( 9,'lla-betis',      'Real Betis',       'BET','#1A7F37',38,17, 3,18, 54,47,49,['W','W','D','L','W'],'W1'),
  st(10,'lla-girona',     'Girona',           'GIR','#CD1414',38,16, 4,18, 52,48,52,['D','W','L','W','D'],'D1'),
  st(11,'lla-celtavigo',  'Celta Vigo',       'CEL','#7BBAD6',38,15, 5,18, 50,44,50,['L','W','D','W','W'],'W2'),
  st(12,'lla-rayo',       'Rayo Vallecano',   'RAY','#E63027',38,14, 6,18, 48,42,50,['D','L','W','W','D'],'D1'),
  st(13,'lla-espanyol',   'Espanyol',         'ESP','#0070B8',38,14, 3,21, 45,38,50,['W','L','L','W','L'],'L1'),
  st(14,'lla-laspalmas',  'Las Palmas',       'LPM','#FFD700',38,13, 3,22, 42,34,50,['L','W','D','L','L'],'L2'),
  st(15,'lla-getafe',     'Getafe',           'GET','#003DA5',38,12, 4,22, 40,32,50,['D','L','W','D','L'],'L1'),
  st(16,'lla-mallorca',   'Mallorca',         'MLL','#DA000D',38,12, 3,23, 39,30,48,['L','W','D','L','D'],'D1'),
  st(17,'lla-osasuna',    'Osasuna',          'OSA','#D4021D',38,11, 5,22, 38,28,48,['L','D','L','W','L'],'L1'),
  st(18,'lla-leganes',    'Leganes',          'LEG','#004B8D',38,10, 5,23, 35,26,50,['D','L','L','D','L'],'L2'),
  st(19,'lla-alaves',     'Alaves',           'ALA','#0056A5',38,10, 4,24, 34,24,50,['L','D','L','L','D'],'D1'),
  st(20,'lla-valladolid', 'Valladolid',       'VLD','#711C8B',38, 8, 6,24, 30,20,50,['L','L','D','L','L'],'L3'),
];
...
const bundesligaStandings: LeagueStanding[] = [
  st( 1,'bun-bayernmunich', 'Bayern Munich',      'BAY','#DC052D',34,26, 4, 4, 82,96,74,['W','W','W','W','W'],'W6'),
  st( 2,'bun-leverkusen',   'Bayer Leverkusen',   'B04','#E32221',34,24, 5, 5, 77,88,68,['W','W','D','W','W'],'W3'),
  st( 3,'bun-leipzig',      'RB Leipzig',         'RBL','#DD0741',34,22, 4, 8, 70,76,58,['W','W','L','W','D'],'D1'),
  st( 4,'bun-dortmund',     'Borussia Dortmund',  'BVB','#FDE100',34,21, 1,12, 64,72,58,['L','W','W','W','L'],'L1'),
  st( 5,'bun-frankfurt',    'Eintracht Frankfurt','SGE','#E1000F',34,20, 2,12, 62,66,54,['W','D','W','L','W'],'W1'),
  st( 6,'bun-freiburg',     'SC Freiburg',        'SCF','#E30012',34,18, 4,12, 58,58, 50,['W','W','D','W','L'],'L1'),
  st( 7,'bun-wolfsburg',    'Wolfsburg',          'WOB','#64A139',34,17, 4,13, 55,54, 50,['D','W','W','L','W'],'W1'),
  st( 8,'bun-hoffenheim',   'Hoffenheim',         'TSG','#1463AF',34,16, 3,15, 51,52, 50,['W','L','D','W','L'],'L1'),
  st( 9,'bun-gladbach',     "Borussia M'gladbach",'BMG','#000000',34,15, 5,14, 50,50, 50,['D','W','D','L','W'],'W1'),
  st(10,'bun-unionberlin',  'Union Berlin',       'UNB','#EB1923',34,14, 6,14, 48,48,50,['L','D','W','W','D'],'D1'),
  st(11,'bun-mainz',        'Mainz 05',           'M05','#C3002F',34,14, 5,15, 47,46,48,['W','L','D','D','W'],'W1'),
  st(12,'bun-augsburg',     'Augsburg',           'FCA','#BA3733',34,13, 5,16, 44,44,48,['D','W','L','L','D'],'D1'),
  st(13,'bun-werderbremen', 'Werder Bremen',      'SVW','#1D9053',34,12, 7,15, 43,42,46,['L','D','W','D','L'],'L1'),
  st(14,'bun-stuttgart',    'VfB Stuttgart',      'VFB','#E32219',34,12, 6,16, 42,40,46,['W','L','D','L','W'],'W1'),
  st(15,'bun-bochum',       'VfL Bochum',         'BOC','#005CAB',34,11, 7,16, 40,38,46,['D','L','W','D','L'],'L1'),
  st(16,'bun-heidenheim',   'Heidenheim',         'HEI','#CC231A',34,10, 8,16, 38,36,46,['L','D','D','W','L'],'L1'),
  st(17,'bun-cologne',      'Cologne',            'KOE','#ED1C24',34, 9, 8,17, 35,32,46,['D','L','L','D','W'],'W1'),
  st(18,'bun-kiel',         'Holstein Kiel',      'KSV','#004B9D',34, 7, 9,18, 30,28,48,['L','D','L','L','D'],'D1'),
];
...
const serieaStandings: LeagueStanding[] = [
  st( 1,'sea-inter',      'Inter Milan',   'INT','#0C1A80',38,29, 6, 3, 93,88,36,['W','W','W','D','W'],'W3'),
  st( 2,'sea-napoli',     'Napoli',        'NAP','#12A0C7',38,27, 4, 7, 85,82,42,['W','W','L','W','W'],'W2'),
  st( 3,'sea-juventus',   'Juventus',      'JUV','#000000',38,25, 6, 7, 81,74,38,['D','W','W','W','L'],'L1'),
  st( 4,'sea-milan',      'AC Milan',      'MIL','#FB090B',38,24, 6, 8, 78,70,42,['W','W','D','W','W'],'W3'),
  st( 5,'sea-atalanta',   'Atalanta',      'ATA','#1C50A0',38,23, 6, 9, 75,72,46,['W','W','W','L','D'],'D1'),
  st( 6,'sea-roma',       'Roma',          'ROM','#8B1B1B',38,21, 5,12, 68,62,48,['L','W','W','W','W'],'W4'),
  st( 7,'sea-lazio',      'Lazio',         'LAZ','#87D8F7',38,20, 5,13, 65,58,48,['W','D','L','W','W'],'W2'),
  st( 8,'sea-fiorentina', 'Fiorentina',    'FIO','#5D2A8C',38,18, 8,12, 62,54, 46,['D','W','D','W','L'],'L1'),
  st( 9,'sea-torino',     'Torino',        'TOR','#780000',38,17, 4,17, 55,48, 46,['W','L','W','D','L'],'L1'),
  st(10,'sea-bologna',    'Bologna',       'BOL','#1A2A6C',38,16, 6,16, 54,46, 44,['D','W','L','W','D'],'D1'),
  st(11,'sea-genoa',      'Genoa',         'GEN','#003DA5',38,15, 6,17, 51,42,44,['W','L','D','W','L'],'L1'),
  st(12,'sea-udinese',    'Udinese',       'UDI','#000000',38,14, 6,18, 48,38,44,['L','D','W','L','W'],'W1'),
  st(13,'sea-lecce',      'Lecce',         'LEC','#FFCC00',38,13, 6,19, 45,34,42,['D','L','W','D','L'],'L1'),
  st(14,'sea-verona',     'Verona',        'VER','#004B9D',38,12, 6,20, 42,30,42,['L','W','D','L','D'],'D1'),
  st(15,'sea-cagliari',   'Cagliari',      'CAG','#1D1160',38,11, 8,19, 41,28,38,['W','D','L','D','L'],'L1'),
  st(16,'sea-empoli',     'Empoli',        'EMP','#0BA3DC',38,11, 7,20, 40,26,38,['L','D','W','L','D'],'D1'),
  st(17,'sea-monza',      'Monza',         'MON','#ED1C24',38,10, 8,20, 38,24,38,['D','L','D','W','L'],'L1'),
  st(18,'sea-venezia',    'Venezia',       'VEN','#000000',38, 9, 9,20, 36,22,36,['L','D','L','D','W'],'W1'),
  st(19,'sea-parma',      'Parma',         'PAR','#FFDD00',38, 9, 7,22, 34,20,38,['L','L','D','L','W'],'W1'),
  st(20,'sea-como',       'Como',          'COM','#004B8D',38, 8, 9,21, 33,18,36,['D','L','D','L','L'],'L2'),
];
...
const ligue1Standings: LeagueStanding[] = [
  st( 1,'lg1-psg',         'Paris Saint-Germain','PSG','#004170',34,27, 5, 2, 86,98,44,['W','W','W','W','W'],'W9'),
  st( 2,'lg1-monaco',      'Monaco',             'MON','#BD0020',34,23, 5, 6, 74,76,46,['W','W','D','W','L'],'L1'),
  st( 3,'lg1-marseille',   'Marseille',          'MAR','#2FAEE0',34,22, 4, 8, 70,68,44,['W','W','W','L','W'],'W2'),
  st( 4,'lg1-lyon',        'Lyon',               'LYN','#CC0000',34,20, 6, 8, 66,62,44,['D','W','W','W','L'],'L1'),
  st( 5,'lg1-lens',        'Lens',               'LEN','#FFCC00',34,19, 5,10, 62,58,44,['W','W','D','L','W'],'W1'),
  st( 6,'lg1-rennes',      'Rennes',             'REN','#DA291C',34,18, 5,11, 59,54,44,['L','W','W','D','W'],'W2'),
  st( 7,'lg1-brest',       'Brest',              'BRE','#E2001A',34,17, 6,11, 57,50, 42,['W','D','W','W','L'],'L1'),
  st( 8,'lg1-lille',       'Lille',              'LIL','#E8000A',34,16, 7,11, 55,46, 40,['D','W','D','W','W'],'W2'),
  st( 9,'lg1-nice',        'Nice',               'NIC','#E21A1A',34,16, 6,12, 54,44, 40,['W','L','W','D','W'],'W1'),
  st(10,'lg1-nantes',      'Nantes',             'NAN','#F6C906',34,14, 8,12, 50,40, 40,['D','W','L','D','W'],'W1'),
  st(11,'lg1-toulouse',    'Toulouse',           'TLS','#542188',34,14, 6,14, 48,38,40,['W','L','D','W','L'],'L1'),
  st(12,'lg1-montpellier', 'Montpellier',        'MPL','#F47920',34,13, 6,15, 45,34,38,['L','W','D','L','W'],'W1'),
  st(13,'lg1-reims',       'Reims',              'REI','#DA291C',34,12, 8,14, 44,32,36,['D','D','W','L','D'],'D1'),
  st(14,'lg1-strasbourg',  'Strasbourg',         'STR','#1C3B7A',34,12, 6,16, 42,30,38,['L','W','D','L','W'],'W1'),
  st(15,'lg1-saintetienne','Saint-Etienne',      'STE','#007931',34,11, 7,16, 40,28,38,['D','L','W','D','L'],'L1'),
  st(16,'lg1-lorient',     'Lorient',            'FCL','#F47920',34,10, 7,17, 37,24,36,['L','D','L','W','D'],'D1'),
  st(17,'lg1-metz',        'Metz',               'FCM','#820A14',34, 9, 7,18, 34,22,36,['L','L','D','L','W'],'W1'),
  st(18,'lg1-auxerre',     'Auxerre',            'AUX','#E2001A',34, 8, 6,20, 30,18,36,['L','D','L','L','D'],'D1'),
];
...
const mlsEastStandings: LeagueStanding[] = [
  st( 1,'mls-intermiami',   'Inter Miami CF',       'MIA','#F7B5CD',34,22, 6, 6, 72,68,46,['W','W','W','D','W'],'W3'),
  st( 2,'mls-columbus',     'Columbus Crew',        'CLB','#FFF200',34,19, 7, 8, 64,58,44,['W','D','W','L','W'],'W1'),
  st( 3,'mls-atlanta',      'Atlanta United',       'ATL','#80000A',34,18, 7, 9, 61,54,44,['W','W','L','D','W'],'W1'),
  st( 4,'mls-philly',       'Philadelphia Union',   'PHI','#071B3A',34,17, 8, 9, 59,50, 42,['D','W','W','W','L'],'L1'),
  st( 5,'mls-nycfc',        'New York City FC',     'NYC','#6CACE4',34,17, 7,10, 58,48, 40,['W','L','D','W','W'],'W2'),
  st( 6,'mls-nashville',    'Nashville SC',         'NSH','#ECE83A',34,16, 8,10, 56,46, 40,['D','W','W','L','D'],'D1'),
  st( 7,'mls-newengland',   'New England Revolution','NE','#C63323',34,15, 8,11, 53,42, 38,['W','D','L','W','W'],'W2'),
  st( 8,'mls-toronto',      'Toronto FC',           'TOR','#B81137',34,14, 9,11, 51,38, 36,['L','W','D','W','D'],'D1'),
  st( 9,'mls-fccincinnati', 'FC Cincinnati',        'CIN','#F05323',34,14, 8,12, 50,36, 36,['W','L','W','D','L'],'L1'),
  st(10,'mls-charlotte',    'Charlotte FC',         'CLT','#1A85C8',34,13, 9,12, 48,34,36,['D','W','L','D','W'],'W1'),
  st(11,'mls-nyredbulls',   'New York Red Bulls',   'RBY','#ED1F26',34,13, 8,13, 47,32,36,['L','D','W','W','L'],'L1'),
  st(12,'mls-chicago',      'Chicago Fire',         'CHI','#9A1724',34,12, 9,13, 45,30,36,['W','D','D','L','W'],'W1'),
  st(13,'mls-dcunited',     'DC United',            'DCU','#000000',34,11, 9,14, 42,28,36,['D','L','W','D','L'],'L1'),
  st(14,'mls-orlando',      'Orlando City',         'ORL','#633492',34,11, 8,15, 41,26,36,['L','W','D','L','D'],'D1'),
  st(15,'mls-montreal',     'CF Montreal',          'MTL','#003DA5',34,10, 8,16, 38,22,34,['L','D','L','W','L'],'L2'),
];

const mlsWestStandings: LeagueStanding[] = [
  st( 1,'mls-lafc',         'LAFC',                 'LAFC','#C39E6D',34,21, 8, 5, 71,68,44,['W','W','D','W','W'],'W3'),
  st( 2,'mls-lagalaxy',     'LA Galaxy',            'LAG','#00245D',34,20, 7, 7, 67,62,42,['W','D','W','L','W'],'W1'),
  st( 3,'mls-seattle',      'Seattle Sounders',     'SEA','#5D9741',34,19, 8, 7, 65,58,40,['D','W','W','W','D'],'D1'),
  st( 4,'mls-rsl',          'Real Salt Lake',       'RSL','#B30838',34,18, 8, 8, 62,54,40,['W','W','D','L','W'],'W1'),
  st( 5,'mls-colorado',     'Colorado Rapids',      'COL','#862633',34,17, 8, 9, 59,50,38,['D','W','W','W','L'],'L1'),
  st( 6,'mls-portland',     'Portland Timbers',     'POR','#004812',34,16, 9, 9, 57,46,36,['W','D','W','D','W'],'W2'),
  st( 7,'mls-vancouver',    'Vancouver Whitecaps',  'VAN','#001C54',34,16, 7,11, 55,42, 34,['L','W','D','W','W'],'W2'),
  st( 8,'mls-sportingkc',   'Sporting Kansas City', 'SKC','#93B3D3',34,15, 8,11, 53,40, 34,['W','D','L','W','D'],'D1'),
  st( 9,'mls-minnesota',    'Minnesota United',     'MIN','#231F20',34,14, 9,11, 51,38, 34,['D','W','D','L','W'],'W1'),
  st(10,'mls-houston',      'Houston Dynamo',       'HOU','#F4811F',34,14, 8,12, 50,36, 34,['L','D','W','W','D'],'D1'),
  st(11,'mls-austin',       'Austin FC',            'ATX','#00B140',34,13, 9,12, 48,34, 34,['W','L','D','D','W'],'W1'),
  st(12,'mls-fcdallas',     'FC Dallas',            'DAL','#E82229',34,13, 7,14, 46,32,34,['D','W','L','L','W'],'W1'),
  st(13,'mls-stlouis',      'St. Louis City SC',    'STL','#A40028',34,12, 8,14, 44,30,34,['L','D','W','D','L'],'L1'),
  st(14,'mls-sanjose',      'San Jose Earthquakes', 'SJE','#0D4C92',34,11, 8,15, 41,26,34,['D','L','L','W','D'],'D1'),
  st(15,'mls-sandiego',     'San Diego FC',         'SDF','#00B0CA',34, 8, 9,17, 33,18,36,['L','D','L','L','W'],'W1'),
];
